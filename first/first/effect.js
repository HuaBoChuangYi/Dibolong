(function () {
    ...
    $(document).ready(function () {
        ...
        canvas.addEventListener('touchend', function () { isdown = false; }, false);
            ...
            for (var i = 0; i < particles.length; i++) {
                ...
                if (isdown == false) {
                    ...
                    if (p.remaining_life < 0 || p.radius < 0) {
                        ...
                        if (mouse != undefined && mouse.x != undefined) {
                            particles[i].location.x = mouse.x;
                            particles[i].location.y = mouse.y;
                        }
                    }
                }
            }
